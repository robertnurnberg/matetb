...
template <typename T>
MateTbBase<T>::MateTbBase(const Options &options) {
...
template <typename T>
bool MateTbBase<T>::allowed_move(Board &board, Move move) {
...
template <typename T>
void MateTbBase<T>::write_tb(const std::string &filename) {
...
template <typename T>
score_t MateTbBase<T>::probe_tb(const std::string &fen) {
...
template <typename T>
std::vector<std::string> MateTbBase<T>::obtain_pv(Board board) {
